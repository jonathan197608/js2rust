// test262_language_expressions_division_S11_5_2_A4_T9.js
// Source: test262/test/language/expressions/division/S11.5.2_A4_T9.js
...
export function test262_language_expressions_division_S11_5_2_A4_T9() {
...
if (Number.MAX_VALUE / 0.9 !== Number.POSITIVE_INFINITY) {
  host_assert_fail('#1: Number.MAX_VALUE / 0.9 === Number.POSITIVE_INFINITY. Actual: ' + (Number.MAX_VALUE / 0.9));
}

//CHECK#2
if (Number.MAX_VALUE / -0.9 !== Number.NEGATIVE_INFINITY) {
  host_assert_fail('#2: Number.MAX_VALUE / -0.9 === Number.NEGATIVE_INFINITY. Actual: ' + (Number.MAX_VALUE / -0.9));
} 
...
//CHECK#4
if (Number.MAX_VALUE / -1 !== -Number.MAX_VALUE) {
  host_assert_fail('#4: Number.MAX_VALUE / -1 === -Number.MAX_VALUE. Actual: ' + (Number.MAX_VALUE / -1));
} 

//CHECK#5
if (Number.MAX_VALUE / (Number.MAX_VALUE / 0.9) === (Number.MAX_VALUE / Number.MAX_VALUE) / 0.9) {
  host_assert_fail('#5: Number.MAX_VALUE / (Number.MAX_VALUE / 0.9) !== (Number.MAX_VALUE / Number.MAX_VALUE) / 0.9');
}
}
