// test262_language_expressions_addition_S11_6_1_A4_T7.js
// Source: test262/test/language/expressions/addition/S11.6.1_A4_T7.js
...
if (-Number.MAX_VALUE + Number.MAX_VALUE !== +0) {  
  host_assert_fail('#2.1: -Number.MAX_VALUE + Number.MAX_VALUE === 0. Actual: ' + (-Number.MAX_VALUE + Number.MAX_VALUE));
} else {
  if (1 / (-Number.MAX_VALUE + Number.MAX_VALUE) !== Number.POSITIVE_INFINITY) {
    host_assert_fail('#2.2: -Number.MAX_VALUE + Number.MAX_VALUE === + 0. Actual: -0');
  }
}
