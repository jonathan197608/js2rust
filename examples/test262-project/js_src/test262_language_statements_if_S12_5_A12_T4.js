// test262_language_statements_if_S12_5_A12_T4.js
// Source: test262/test/language/statements/if/S12.5_A12_T4.js
...
export function test262_language_statements_if_S12_5_A12_T4() {
...
if(true)
  if (true)
    c=2;
if (c!==2)
    host_assert_fail('#2: At embedded "if/else" constructions engine must select right branches');
