...
fn main() {
    ...
    match frag.as_str() {
        ...
        "test_expressions_frag_1" => {
            testExpressions_frag_1_app();
        }
        "test_expressions_frag_106" => {
            testExpressions_frag_106_app();
        }
        "test_expressions_frag_113" => {
            testExpressions_frag_113_app();
        }
        "test_expressions_frag_119" => {
            testExpressions_frag_119_app();
        }
        "test_expressions_frag_128" => {
            testExpressions_frag_128_app();
        }
        "test_expressions_frag_13" => {
            testExpressions_frag_13_app();
        }
        "test_expressions_frag_135" => {
            testExpressions_frag_135_app();
        }
        "test_expressions_frag_142" => {
            testExpressions_frag_142_app();
        }
        "test_expressions_frag_149" => {
            testExpressions_frag_149_app();
        }
        "test_expressions_frag_156" => {
            testExpressions_frag_156_app();
        }
        "test_expressions_frag_157" => {
            testExpressions_frag_157_app();
        }
        "test_expressions_frag_18" => {
            testExpressions_frag_18_app();
        }
        "test_expressions_frag_19" => {
            testExpressions_frag_19_app();
        }
        "test_expressions_frag_25" => {
            testExpressions_frag_25_app();
        }
        "test_expressions_frag_29" => {
            testExpressions_frag_29_app();
        }
        "test_expressions_frag_33" => {
            testExpressions_frag_33_app();
        }
        "test_expressions_frag_38" => {
            testExpressions_frag_38_app();
        }
        "test_expressions_frag_42" => {
            testExpressions_frag_42_app();
        }
        "test_expressions_frag_46" => {
            testExpressions_frag_46_app();
        }
        "test_expressions_frag_52" => {
            testExpressions_frag_52_app();
        }
        "test_expressions_frag_53" => {
            testExpressions_frag_53_app();
        }
        "test_expressions_frag_54" => {
            testExpressions_frag_54_app();
        }
        "test_expressions_frag_55" => {
            testExpressions_frag_55_app();
        }
        "test_expressions_frag_56" => {
            testExpressions_frag_56_app();
        }
        "test_expressions_frag_57" => {
            testExpressions_frag_57_app();
        }
        "test_expressions_frag_59" => {
            testExpressions_frag_59_app();
        }
        "test_expressions_frag_62" => {
            testExpressions_frag_62_app();
        }
        "test_expressions_frag_63" => {
            testExpressions_frag_63_app();
        }
        "test_expressions_frag_64" => {
            testExpressions_frag_64_app();
        }
        "test_expressions_frag_65" => {
            testExpressions_frag_65_app();
        }
        "test_expressions_frag_66" => {
            testExpressions_frag_66_app();
        }
        "test_expressions_frag_67" => {
            testExpressions_frag_67_app();
        }
        "test_expressions_frag_69" => {
            testExpressions_frag_69_app();
        }
        "test_expressions_frag_71" => {
            testExpressions_frag_71_app();
        }
        "test_expressions_frag_76" => {
            testExpressions_frag_76_app();
        }
        "test_expressions_frag_8" => {
            testExpressions_frag_8_app();
        }
        "test_expressions_frag_84" => {
            testExpressions_frag_84_app();
        }
        "test_expressions_frag_86" => {
            testExpressions_frag_86_app();
        }
        "test_expressions_frag_87" => {
            testExpressions_frag_87_app();
        }
        "test_expressions_frag_89" => {
            testExpressions_frag_89_app();
        }
        "test_expressions_frag_99" => {
            testExpressions_frag_99_app();
        }
        ...
        "test_builtins_frag_103" => {
            testBuiltins_frag_103_app();
        }
        "test_builtins_frag_105" => {
            testBuiltins_frag_105_app();
        }
        "test_builtins_frag_106" => {
            testBuiltins_frag_106_app();
        }
        "test_builtins_frag_107" => {
            testBuiltins_frag_107_app();
        }
        "test_builtins_frag_110" => {
            testBuiltins_frag_110_app();
        }
        "test_builtins_frag_113" => {
            testBuiltins_frag_113_app();
        }
        "test_builtins_frag_137" => {
            testBuiltins_frag_137_app();
        }
        "test_builtins_frag_158" => {
            testBuiltins_frag_158_app();
        }
        "test_builtins_frag_169" => {
            testBuiltins_frag_169_app();
        }
        "test_builtins_frag_172" => {
            testBuiltins_frag_172_app();
        }
        "test_builtins_frag_175" => {
            testBuiltins_frag_175_app();
        }
        "test_builtins_frag_179" => {
            testBuiltins_frag_179_app();
        }
        _ => {
