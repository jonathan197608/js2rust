...
fn run_fragment(frag: &str) -> bool {
    match frag {
        ...
        "test_edge_frag_0" => {
            let _ = testEdge_frag_0();
            true
        }
        "test_edge_frag_1" => {
            let _ = testEdge_frag_1();
            true
        }
        "test_edge_frag_13" => {
            let _ = testEdge_frag_13();
            true
        }
        "test_edge_frag_14" => {
            let _ = testEdge_frag_14();
            true
        }
        "test_edge_frag_2" => {
            let _ = testEdge_frag_2();
            true
        }
        "test_edge_frag_3" => {
            let _ = testEdge_frag_3();
            true
        }
        "test_edge_frag_25" => {
        ...
        "test_edge_frag_6" => {
            let _ = testEdge_frag_6();
            true
        }
        "test_edge_frag_22" => {
            let _ = testEdge_frag_22();
            true
        }
        "test_edge_frag_23" => {
            let _ = testEdge_frag_23();
            true
        }
        "test_edge_frag_7" => {
            let _ = testEdge_frag_7();
            true
        }
        "test_edge_frag_8" => {
            let _ = testEdge_frag_8();
            true
        }
        "test_edge_frag_4" => {
            let _ = testEdge_frag_4();
            true
        }
        "test_edge_frag_24" => {
            let _ = testEdge_frag_24();
            true
        }
        "test_edge_frag_27" => {
            let _ = testEdge_frag_27();
            true
        }
        "test_edge_frag_28" => {
            let _ = testEdge_frag_28();
            true
        }
        _ => false,
    }
