...
use crate::zigir::types::{
    IrAssignTarget, IrBlock, IrClassDecl, IrClassField, IrClassMethod, IrClosureStruct,
    IrDestructureDecl, IrFnDecl, IrForInKind, IrForOfKind, IrStmt, IrSwitchCase, IrTypedef,
    IrVarDecl,
};
...
impl Emitter {
    ...
    fn emit_destructure_decl(&mut self, data: &IrDestructureDecl) {
    ...
    fn infer_hashmap_conv(&self, default: &crate::zigir::types::IrExpr) -> &'static str {
